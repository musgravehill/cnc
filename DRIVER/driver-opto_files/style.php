...
ul.post-reputation li.rate-good-icon a { background-image: url("./styles/prosilver/imageset/icon_rate_good.gif"); }
ul.post-reputation li.rate-bad-icon a { background-image: url("./styles/prosilver/imageset/icon_rate_bad.gif"); }
...
.reputation-delete {
	background-image: url("./styles/prosilver/theme/images/reputation_delete.png");
	background-repeat: no-repeat;
	font-size: 0px;
	width: 16px;
	height: 16px;
